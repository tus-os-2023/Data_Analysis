...
def translate_column_names(data):
    ...
    translated_columns = [
        "年月日", "日照時間", "日照時間_現象なし情報", "最深積雪",
        "最深積雪_現象なし情報", "平均風速", "平均蒸気圧", "平均湿度",
        "平均海面気圧", "平均現地気圧", "平均雲量", "平均気温",
        "合計全天日射量", "降水量の合計", "降水量の合計_現象なし情報",
        "降雪量合計", "降雪量合計_現象なし情報", "最高気温", "最低気温",
        "最多風向", "最大風速", "最大風速_風向", "最低海面気圧",
        "最低海面気圧_現象なし情報", "最小相対湿度", "10分間降水量の最大",
        "10分間降水量の最大_現象なし情報", "最大瞬間風速", "最大瞬間風速_風向",
        "日中天気概況", "夜間天気概況"
    ]
...
def aggregate_csv_files(folder_path, start_year, num_years):
    ...
    compiled_filename = f'Compiled_{start_year}-{start_year+num_years}_JP.csv'
    result.to_csv(
